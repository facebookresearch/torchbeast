...
RUN git clone -b v1.3.1 --recursive https://github.com/pytorch/pytorch
...
RUN pip install gym[atari]>=0.14.0 gitpython>=2.1 opencv-python
...
# Run.
CMD ["bash", "-c", "python -m scripts.run_single_machine \
       --num_actors 10 \
